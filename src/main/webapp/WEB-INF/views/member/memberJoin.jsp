...
<div class="container">
  <form name="myform" method="post" class="was-validated">
    ...
    <div class="form-group">
      <label for="mid">아이디<input type="button" value="아이디 중복체크" id="midBtn" class="btn btn-secondary btn-sm ml-2" onclick="idCheck()"/></label>
    ...
    <div class="form-group">
      <label for="nickName">닉네임<input type="button" id="nickNameBtn" value="닉네임 중복체크" class="btn btn-secondary btn-sm ml-2" onclick="nickCheck()"/></label>
    ...
    <div class="form-group">
      <div class="form-check-inline">
        <span class="input-group-text mr-3">성별</span>
    ...
    <div class="form-group">
	    ...
	    <div class="form-row">
		    <div class="col">
	      	<select name="tel1" class="form-control col">
    ...
    <div  class="form-group">
    	<label for="photo">회원 사진(파일용량:2MByte이내) :</label>
